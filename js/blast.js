...
function startBlastJsEffect() {
  ...
  setTimeout(function() {
    $(".flat-button").addClass("animated bounceIn");
    $(
      ".flat-button"
    ).one(
      "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
      function() {
        $(".flat-button").removeClass("animated bounceIn");
        $(".flat-button").css("opacity", 1);
      }
    );
  }, 2000);

  $(".flat-button").mouseenter(function() {
    var el = $(this);
